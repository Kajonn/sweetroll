...
- [ ] **Step 1: Write the failing public-contract and package-loader tests**
...
- [ ] **Step 3: Define the complete public Runtime contract**
...
- [ ] **Step 4: Implement package loaders**
...
- [ ] **Step 5: Verify loader corruption mapping**
...
- [ ] **Step 1: Add failing all-field initialize/observe tests**
...
- [ ] **Step 2: Add failing invalid-state tests**
...
- [ ] **Step 3: Add failing entity/action scope compilation tests**
...
- [ ] **Step 5: Implement state indexing and validation**
...
- [ ] **Step 6: Implement derived and authored validation evaluation**
...
- [ ] **Step 7: Implement the projection builder**
...
- [ ] **Step 8: Implement the Runtime factory and dispatch**
...
- [ ] **Step 9: Tighten compile-document scope**
...
- [ ] **Step 10: Run focused, package, and type tests**
...
- [ ] **Step 2: Add failing deterministic-roll tests**
...
- [ ] **Step 3: Add failing evaluator scope/limit tests**
...
- [ ] **Step 6: Update evaluator bindings and limits**
...
- [ ] **Step 7: Implement the three command intents**
...
- [ ] **Step 8: Add required configuration**
...
- [ ] **Step 9: Run Runtime, rules, typecheck, and full backend tests**
...
- [ ] **Step 2: Write failing version-access and publication tests**
...
- [ ] **Step 3: Write failing pinned-delete conflict test**
...
- [ ] **Step 6: Add version-use authorization**
...
- [ ] **Step 7: Implement acknowledged breaking publication**
...
- [ ] **Step 8: Map pinned deletes to conflict**
...
- [ ] **Step 9: Run migration, integration, HTTP, contracts, and typecheck**
...
- [ ] **Step 1: Write failing Interface integration tests**
...
- [ ] **Step 2: Add failing create rollback and access tests**
...
- [ ] **Step 4: Define the Characters public contract**
...
- [ ] **Step 7: Run focused integration and typecheck**
...
- [ ] **Step 1: Write failing set/bump behavior tests**
...
- [ ] **Step 5: Implement execution claiming**
...
- [ ] **Step 6: Implement apply transaction ordering**
...
- [ ] **Step 7: Implement conflict reconciliation**
...
- [ ] **Step 8: Run focused integration tests three times**
...
- [ ] **Step 1: Write failing action tests across all fixtures**
...
- [ ] **Step 2: Write failing retry/atomicity tests**
...
- [ ] **Step 4: Implement action workflow**
...
- [ ] **Step 5: Verify restart-safe determinism**
...
- [ ] **Step 2: Write failing activity pagination tests**
...
- [ ] **Step 5: Implement management commands**
...
- [ ] **Step 6: Implement activity and canonical export**
...
- [ ] **Step 6: Persist immutable previews**
...
- [ ] **Step 7: Implement commit and rollback transactions**
...
- [ ] **Step 8: Run migration and all integration tests**
...
- [ ] **Step 1: Write failing route-definition and handler tests**
...
- [ ] **Step 2: Write failing header/media tests**
...
- [ ] **Step 3: Add failing OpenAPI path expectations**
...
- [ ] **Step 5: Implement character schemas/routes/handlers**
...
- [ ] **Step 6: Extend OpenAPI media representation**
...
- [ ] **Step 7: Compose production Modules**
...
- [ ] **Step 8: Regenerate and check contracts**
...
- [ ] **Step 9: Run transport, backend, web typecheck, and build**
...
- [ ] **Step 1: Write the complete HTTP acceptance test**
...
- [ ] **Step 2: Add offline-replay cases**
...
- [ ] **Step 3: Add all-reference-system coverage**
...
- [ ] **Step 8: Mark I3 closed in the design**
