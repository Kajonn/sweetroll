...
- `npm run web:test -- src/characters/CharacterSheet.test.tsx src/characters/FieldControl.test.tsx`: 5 passing tests.
- `npm run web:typecheck`: passed.
- `npm run web:test`: 391 passing tests in 51 files. The existing suite emits React `act(...)` warnings from router tests; no tests fail.
